...
module AuthenticatedTestHelper
  ...
  # assert the given user as the current user w/o respect to authentication
  # by storing the id in the session cache. this prepares for current_user, but does
  # not change it directly, as that is protected. nb. this means one login only per test.
  def login_as(user)
